...
/** SELECT YOUR PLATFORM BY UNCOMMENTING. HLib supports STM32F100_STARTER and MBoard1 currently */
...
/** SELECT HLib INITIAL CHECKING BY UNCOMMENTING*/
#define INITIAL_CHECK

/** SELECT HLib PARAMETER CHECKING BY UNCOMMENTING*/
